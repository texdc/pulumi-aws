 ...
 * 
 * const examplegetEventCategories = pulumi.output(aws.rds.getEventCategories({}));
 * 
 * export const example = examplegetEventCategories.apply(__arg0 => __arg0.eventCategories);
 * ```
