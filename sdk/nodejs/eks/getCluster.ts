 ...
 * }));
 * 
 * export const endpoint = example.apply(__arg0 => __arg0.endpoint);
 * export const kubeconfig_certificate_authority_data = example.apply(__arg0 => __arg0.certificateAuthority.data);
 * ```
 */
